...
namespace EFCoreWebApi.Entidades.Seeding
{
    public class SeedingInicial
    {
        public static void Seed(ModelBuilder modelBuilder)
        {
            ...
            var comentariosAvengers = new Comentario()
            {
                Id = 2,
                Recomendar = true,
                Contenido = "Muy Buena!!",
            ...
            var comentariosAvengers2 = new Comentario()
            {
                Id = 3,
                Recomendar = true,
                Contenido = "Dura Dura",
            ...
            var comentariosNWH = new Comentario()
            {
                Id = 4,
                Recomendar = false,
            ...
            var comentarioSpiderVerse = new Comentario()
            {
                Id = 5,
                Recomendar = true,
            ...
            modelBuilder.Entity<Comentario>().HasData(comentariosAvengers, comentariosAvengers2, comentariosNWH, comentarioSpiderVerse);

            //Tabla muchos a muchos con salto (advance)
            //
